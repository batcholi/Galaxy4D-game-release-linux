...
void main() {
	...
	voxelSurface.geometryInfo = GEOMETRY.info;
	...
	// if (OPTION_TEXTURES) {
		executeCallableEXT(GEOMETRY.info.surfaceIndex + uint32_t(voxelData.type[voxelIndex]), VOXEL_SURFACE_CALLABLE_PAYLOAD);
	// }
